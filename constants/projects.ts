...
export const PROJECTS: Project[] = [
  {
    image: getProjectImage('nestjsAuthApi'),
    name: 'Nestjs-auth-api',
    github: 'https://github.com/mttetc/nestjs-auth-api',
    description: 'Complete authentication API',
    stack: ['Nest.js', 'TypeScript', 'PostgreSQL', 'Prisma', 'Neon', 'JWT', 'Redis'],
  },
  {
    image: getProjectImage('cryptosentry'),
    name: 'CryptoSentry',
    github: 'https://github.com/mttetc/cryptosentry',
    description:
      'Real-time market monitoring and alert system with custom filters based on X (Twitter) and Telegram',
    stack: [
      'Next.js',
      'React',
      'TypeScript',
  ...
  {
    image: getProjectImage('tabs'),
    name: 'Tabs',
    github: 'https://github.com/mttetc/tabs',
    description: 'A custom, accessible, and fully tested tabs component built for design systems',
    stack: ['React', 'TypeScript', 'TailwindCSS', 'Jest', 'Storybook', 'Framer Motion'],
  },
  {
    image: getProjectImage('livethread'),
    name: 'Livethread',
    github: 'https://github.com/mttetc/livethread',
    description: 'A real-time messaging application with live threads and commenting',
    stack: ['Angular', 'Nest.js', 'Node.js', 'TypeScript', 'Primeng'],
  },
